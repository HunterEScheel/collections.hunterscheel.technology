    ...
    switch (action) {
      ...
      case "set_hex_terrain": {
        ...
        if (terrain === "unknown") {
          ...
          const { error } = await supa.from("hexmap_hexes").upsert(
            { col, row, terrain },
            { onConflict: "col,row" }
          );
          if (error) return serverError(error.message);
      ...
      case "create_quest": {
        ...
        const { error } = await supa.from("hexmap_quests").insert(insert);
        if (error) return serverError(error.message);
        return ok();
      }
      ...
      case "update_quest": {
        ...
        const { error } = await supa.from("hexmap_quests").update(updates).eq("id", id);
        if (error) return serverError(error.message);
        return ok();
      }
      ...
      case "delete_quest": {
        ...
        const { error } = await supa.from("hexmap_quests").delete().eq("id", id);
        if (error) return serverError(error.message);
        return ok();
      }
      ...
      case "remove_initiative_entry": {
        ...
        const { error } = await supa
          .from("hexmap_initiative_tracker")
          .delete()
          .eq("id", id);
        if (error) return serverError(error.message);
        return ok();
      ...
      case "shop_insert_items": {
        ...
        const { error } = await supa.from("hexmap_shop_inventory").insert(items);
        if (error) return serverError(error.message);
        return ok();
      }
      ...
      case "restock_rule_upsert": {
        const r = payload;
        const { error } = await supa.from("hexmap_shop_restock_rules").upsert(
          {
      ...
      case "restock_rule_update": {
        ...
        const { error } = await supa
          .from("hexmap_shop_restock_rules")
          .update(updates)
          .eq("id", id);
        if (error) return serverError(error.message);
        return ok();
