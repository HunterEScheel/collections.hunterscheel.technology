...
- **Contribute (`/`)** — after unlocking: enter your name, amount, and a firework request (fountain, willow, chrysanthemum, brocade, candles, batteries, parachutes, fish, or other). Shows the running total and all contributions for the event.
