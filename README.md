...
- **Contribute (`/`)** — after unlocking: enter your name, amount, and a firework request (fountain, willow, chrysanthemum, brocade, candle, parachutes, fish, or buyer's choice). Shows the running total and all contributions for the event.
